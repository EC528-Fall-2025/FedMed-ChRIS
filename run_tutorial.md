...
- `fedmed/pl-superlink:0.2.0` – spins up a Flower **SuperLink** and launches the bundled FedMed **ServerApp**.
- `fedmed/pl-supernode:0.2.0` – starts a Flower **SuperNode** that executes the FedMed **ClientApp**.
...
```bash
docker build -t docker.io/fedmed/pl-superlink:0.2.0 plugins/superlink_plugin
docker build -t docker.io/fedmed/pl-supernode:0.2.0 plugins/supernode_plugin
```
...
```
✔ docker.io/fedmed/pl-superlink:0.2.0 http://chris:8000/api/v1/plugins/6/
✔ docker.io/fedmed/pl-supernode:0.2.0 http://chris:8000/api/v1/plugins/7/
```
...
2. Remove the OCI images if you no longer need them:
   ```bash
   docker image rm docker.io/fedmed/pl-superlink:0.2.0 docker.io/fedmed/pl-supernode:0.2.0
   ```
