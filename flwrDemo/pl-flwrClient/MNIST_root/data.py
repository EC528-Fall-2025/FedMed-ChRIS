...
def mnist_loaders(batch_size: int, num_workers: int = 2):
    ...
    train_ds = datasets.MNIST(root="MNIST_root/data", train=True,  download=True, transform=tfm)
    test_ds  = datasets.MNIST(root="MNIST_root/data", train=False, download=True, transform=tfm)
